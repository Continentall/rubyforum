...
module Internationalization
    ...
    included do
      ...
      def switch_locale(&action) # &action - любое действие которое контроллеру надо выполнить
      ...
      def locale_from_headers # Запутаный метод с github который парсит предпочтиьаемую пользователем локаль
